...
setup(
    name="Python Ethereum RPC",
    version="0.0.1",
    description="Ethereum RPC",
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="https://github.com/bitwyre/python-ethrpc",
    ...
    project_urls={
        "Bug Reports": "https://github.com/bitwyre/python-ethrpc/issues",
        "Funding": "https://bitwyre.com",
        "Say Thanks!": "http://bitwyre.gives",
        "Source": "https://github.com/bitwyre/python-ethrpc/",
    },
)
